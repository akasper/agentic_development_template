...
| Process | Add canonical upstream PLATE template synchronization guidance: new `AGENTS.md` sync section, dedicated synchronization skill, and `.plate/upstream-ref` tracking file for commit-range based safe merges that preserve downstream customization. | — | Pending merge | `AGENTS.md`, `.agentic/skills.yml`, `.agentic/skills/plate-template-synchronization.md`, `.plate/upstream-ref`, `CURRENT.md`. |
