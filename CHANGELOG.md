...
| Process | Add GitHub bootstrap guidance and automation based on recent repository setup lessons, including atomic PR labeling guidance for agents. | — | Pending merge | `README.md`, `AGENTS.md`, `CONTRIBUTING.md`, `.github/copilot-instructions.md`, `docs/bootstrap/new-repository-checklist.md`, `scripts/bootstrap_github.py`. |
